...
namespace Re.Common
{
  /*  /// <summary>
    ...
    public class LayoutAwarePage : System.Windows.Controls.Page
    {
        /// <summary>
        ...
        /// <seealso cref="InvalidateVisualState"/>
        protected virtual string DetermineVisualState()// I don't think we need this in WP8? ApplicationViewState viewState)
        {
            return "Landscape"; // Because it's always landscape...? viewState.ToString();
        }
