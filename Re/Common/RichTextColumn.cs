...
{ /*
    /// <summary>
    /// Wrapper for <see cref="RichTextBox"/> that creates as many additional overflow
    ...
    ///         <DataTemplate>
    ///             <RichTextBoxOverflow Width="400" Margin="50,0,0,0"/>
    ///         </DataTemplate>
    ///     </RichTextColumns.ColumnTemplate>
    ///     
    ...
    [System.Windows.Markup.ContentPropertyAttribute("RichTextContent")]
    public sealed class RichTextColumns : Panel
    {
        ...
        public static readonly DependencyProperty RichTextContentProperty =
            DependencyProperty.Register("RichTextContent", typeof(RichTextBox),
        ...
        {
            get { return (RichTextBox)GetValue(RichTextContentProperty); }
            set { SetValue(RichTextContentProperty, value); }
        }

        /// <summary>
        /// Gets or sets the template used to create additional
        /// <see cref="RichTextBoxOverflow"/> instances.
        /// </summary>
        ...
        /// RichTextBox child.
        /// </summary>
        private List<RichTextBox> _overflowColumns = null;
        ...
        {
            if (this.RichTextContent == null) return new System.Windows.Size(0, 0);

            // Make sure the RichTextBox is a child, using the lack of
            ...
            if (this._overflowColumns == null)
            {
                ...
                this._overflowColumns = new List<System.Windows.Controls.RichTextBox>();
            }

            // Start by measuring the original RichTextBox content
            ...
            while (hasOverflow && maxWidth < availableSize.Width && this.ColumnTemplate != null)
            {
                ...
                {
                    overflow = (RichTextBoxOverflow)this.ColumnTemplate.LoadContent();
